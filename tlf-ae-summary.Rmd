...
Following [ICH E3 guidance](https://database.ich.org/sites/default/files/E3_Guideline.pdf), we need to summarize which patients were included in each efficacy analysis in Section 12.2, Adverse Events (AEs).
...
We summarize the number and percentage of patients who meet each AE criteria.
