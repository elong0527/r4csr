...
For an organization, it is possible to have multiple ongoing clinical trials in a clincial program. 
...
If the R version mismatch, an error message is displayed.
