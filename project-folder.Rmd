...
To deliver A&R results of a clinical trial project, it is teamwork that typically requires
...
Consistent folder structure also reduces communication costs between study team members 
...
the current R version is the same as we defined in `.Rprofile` 
