...
subtitle: "RStudio Pharma Meetup Series"
author: "Yilong Zhang"
date: "May 2022"
output:
...
- All opinions expressed are those of the presenter and not represent any organization.
...
## r2rtf: create TLFs in RTF format
...
- As statisticians, we use `tidyverse`, `r2rtf`,
...
- As programmers, we use `tidyverse`, `r2rtf`, and internal tools to develop and/or validate analysis results based on mock-up TLFs.

- As statisticans/programmers, we use `pkglite` and internal tools to prepare proprietary R packages and analysis R scripts for eCTD submission package.

- As an internal/external reviewers, we use `cleanslate` to re-construct a portable environment (if required) to reproduce analysis results.
...
More details: <https://r4csr.org/folder.html>
