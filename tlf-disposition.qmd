...
To prepare a simplified disposition of participants table using the `adsl` dataset, the following variables are used:
...
By using `tbl_disp` as input, we can generate the disposition table using following code.
