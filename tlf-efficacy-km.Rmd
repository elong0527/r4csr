...
::: {.rmdnote}
There are R packages that can create more informative Kaplan-Meier plot such as `visR` and `survminer`.
Interested reader can find examples in their package website. 
::: 
...
The `survival` package is used to obtain the K-M estimator. 
...
Using code below, we save the simplified KM plot into a `.png` file.
...
More details can be found in [r2rtf website](https://merck.github.io/r2rtf/articles/example-figure.html).
...
- Step 4: Create RTF table using `r2rtf` package.
