...
The demo project (R package) we will prepare for submission is called [`esubdemo`](https://github.com/elong0527/esubdemo.git) available on GitHub.
...
- ARM: provide the links between TLFs and analysis programs in tables.
...
To prepare R packages for submission, one needs to pack the packages into a text files, and then verify if the file only contains ASSCII.
