...
we need to summarize the accounting of all participants who entered the study, 
...
as well as the reasons for all post-randomization discontinuations, 
...
We illustrate how to prepare a report data for a simplified disposition of participants table using variables below:
...
-   Step 2: Count participants in the analysis population and name the dataset as `n_rand`.
-   Step 3: Count the number and percentage of participants who discontinued the study, and name the dataset as `n_disc`.
-   Step 4: Count the number and percentage of participants who discontinued the study in different reasons, and name the dataset as `n_reason`. Format it using `r2rtf`.
-   Step 5: Count the number and percentage of participants who completed the study, and name the dataset as `n_complete`.
