...
In this chapter, we show how to the create a typical disposition table.
...
This dataset is provided in `sas7bdat` format, which is a SAS data format currently used in many clinical trial analysis and report.
